return {
    ...
    Zones = {
        { coords = vec3(-1189.5997, -894.7845, 13.9370), radius = 0.5, icon = 'far fa-clipboard', event = 'randol_burgershot:client:frontTray', label = 'Food Tray', type = 'stash', stashLabel = 'BS_Front_Tray_1', slots = 10, weight = 75000}, 
        { coords = vec3(-1188.5188, -894.3071, 13.9445), radius = 0.5, icon = 'far fa-clipboard', event = 'randol_burgershot:client:frontTray2', label = 'Food Tray', type = 'stash', stashLabel = 'BS_Front_Tray_2', slots = 10, weight = 75000}, 
        { coords = vec3(-1191.4120, -898.0420, 13.9463), radius = 0.5, icon = 'fa-solid fa-beer-mug-empty', event = 'randol_burgershot:client:drinkStation', label = 'Make Drinks', job = 'burgershot' },
        { coords = vec3(-1186.8680, -900.5117, 13.9463), radius = 0.5, icon = 'fa-solid fa-burger', event = 'randol_burgershot:client:cookBurgers', label = 'Make Burgers', job = 'burgershot' }, 
        { coords = vec3(-1187.4113, -899.6816, 13.9463), radius = 0.5, icon = 'fa-solid fa-fire-burner', event = 'randol_burgershot:client:friesStation', label = 'Make Fries', job = 'burgershot' },
        { coords = vec3(-1192.6149, -898.4216, 13.7984), radius = 0.7, icon = 'fa-solid fa-box-open', event = 'randol_burgershot:client:ingredientStore', label = 'Ingredients', job = 'burgershot', type = 'shop' },
        { coords = vec3(-1187.3833, -896.9667, 13.9463), radius = 0.7, icon = 'far fa-clipboard', event = 'randol_burgershot:client:passThrough', label = 'Big Tray', job = 'burgershot', type = 'stash', stashLabel = 'BS_Big_Tray', slots = 20, weight = 150000 },
    },
