return {
    ...
    Zones = {
        { coords = vec3(-1192.8289, -893.8292, 13.9786), radius = 0.5, icon = 'far fa-clipboard', event = 'randol_burgershot:client:frontTray', label = 'Food Tray', type = 'stash', stashLabel = 'BS_Front_Tray_1', slots = 10, weight = 75000}, 
        { coords = vec3(-1194.9014, -893.3874, 14.0082), radius = 0.5, icon = 'far fa-clipboard', event = 'randol_burgershot:client:frontTray2', label = 'Food Tray', type = 'stash', stashLabel = 'BS_Front_Tray_2', slots = 10, weight = 75000}, 
        { coords = vec3(-1190.8329, -898.1735, 13.8862), radius = 0.7, icon = 'fa-solid fa-beer-mug-empty', event = 'randol_burgershot:client:drinkStation', label = 'Make Drinks', job = 'burgershot' },
        { coords = vec3(-1194.9701, -897.4238, 13.7741), radius = 0.5, icon = 'fa-solid fa-burger', event = 'randol_burgershot:client:cookBurgers', label = 'Make Burgers', job = 'burgershot' }, 
        { coords = vec3(-1195.9644, -899.695, 13.8862), radius = 0.5, icon = 'fa-solid fa-fire-burner', event = 'randol_burgershot:client:friesStation', label = 'Make Fries', job = 'burgershot' },
        { coords = vec3(-1196.6216, -901.4202, 13.8862), radius = 0.7, icon = 'fa-solid fa-box-open', event = 'randol_burgershot:client:ingredientStore', label = 'Ingredients', job = 'burgershot', type = 'shop' },
        { coords = vec3(-1194.9235, -895.9495, 13.8862), radius = 1.0, icon = 'far fa-clipboard', event = 'randol_burgershot:client:passThrough', label = 'Big Tray', job = 'burgershot', type = 'stash', stashLabel = 'BS_Big_Tray', slots = 20, weight = 150000 },
    },
